 ...
 * @copyright Copyright (c) 2007-2017 Zoosk Inc.
 */

use Zoosk\Core\Jobs\WorkshopJob;

require_once __DIR__ . '/scripts.php';

$job = new WorkshopJob('foo bar');
Queue::Push($job);

return;

$user = User::LoadUser(10);
$searchType = V8_SearchType::GENERAL_SITE_SHADOW;

// get results
$engine = V8_SearchEngineFactory_GeneralSite::GetEngine($user, [], $searchType);
$results = $engine->getResults(20);
